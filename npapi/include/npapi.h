...
/*
 *  npapi.h Mozilla 3.48 But with MACOS and WINDOWS stuff removed and
 *  some stuff commented out for backwards compatibility
...
NPError NP_LOADDS NPP_GetValue(void * instance, NPPVariable variable, void *value);
